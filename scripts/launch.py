...
# ║   ⚠️  警告：請勿直接執行此腳本！ ⚠️                            ║
# ║                                                                      ║
# ║   此腳本是核心啟動器，負責建立虛擬環境並安裝依賴。                 ║
# ║   它必須由更高層的包裝器（如 `local_run.py`）呼叫。                ║
# ║                                                                      ║
# ║   直接用 `python scripts/launch.py` 執行可能會因為環境變數缺失、    ║
# ║   工作目錄不正確等問題，導致無法預期的掛起、崩潰或資料庫損壞。     ║
# ║                                                                      ║
# ║   在進行任何修改或偵錯前，請務必先詳閱 `docs/` 目錄下的相關技術   ║
# ║   文件，以了解完整的啟動流程和架構。                               ║
# ║                                                                      ║
# ╚══════════════════════════════════════════════════════════════════╝
